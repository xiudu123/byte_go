...
func (x *ListProductByIdsReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ListProductByIdsReq[number], err)
}

func (x *ListProductByIdsReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
...
func (x *ListProductByIdsResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ListProductByIdsResp[number], err)
}

func (x *ListProductByIdsResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v Product
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *ListProductByIdsReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ListProductByIdsReq) fastWriteField1(buf []byte) (offset int) {
...
func (x *ListProductByIdsResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ListProductByIdsResp) fastWriteField1(buf []byte) (offset int) {
	if x.Products == nil {
		return offset
	}
	for i := range x.GetProducts() {
...
func (x *CreateCategoryResp) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint32(buf[offset:], 1, x.GetCategoryId())
	return offset
}
...
func (x *ListProductByIdsReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ListProductByIdsReq) sizeField1() (n int) {
	if len(x.ProductIds) == 0 {
		return n
	}
...
func (x *ListProductByIdsResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ListProductByIdsResp) sizeField1() (n int) {
	if x.Products == nil {
		return n
	}
	for i := range x.GetProducts() {
...
func (x *CreateCategoryResp) sizeField1() (n int) {
	...
	n += fastpb.SizeUint32(1, x.GetCategoryId())
	return n
}
...
var fieldIDToName_ListProductByIdsReq = map[int32]string{
	1: "ProductIds",
}

var fieldIDToName_ListProductByIdsResp = map[int32]string{
	1: "Products",
}
