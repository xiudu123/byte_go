...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"ListProductByIds": kitex.NewMethodInfo(
		listProductByIdsHandler,
		newListProductByIdsArgs,
		newListProductByIdsResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
...
func listProductByIdsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(product.ListProductByIdsReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(product.ProductCatalogService).ListProductByIds(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ListProductByIdsArgs:
		success, err := handler.(product.ProductCatalogService).ListProductByIds(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*ListProductByIdsResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newListProductByIdsArgs() interface{} {
	return &ListProductByIdsArgs{}
}

func newListProductByIdsResult() interface{} {
	return &ListProductByIdsResult{}
}

type ListProductByIdsArgs struct {
	Req *product.ListProductByIdsReq
}

func (p *ListProductByIdsArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(product.ListProductByIdsReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *ListProductByIdsArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *ListProductByIdsArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *ListProductByIdsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *ListProductByIdsArgs) Unmarshal(in []byte) error {
	msg := new(product.ListProductByIdsReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ListProductByIdsArgs_Req_DEFAULT *product.ListProductByIdsReq

func (p *ListProductByIdsArgs) GetReq() *product.ListProductByIdsReq {
	if !p.IsSetReq() {
		return ListProductByIdsArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *ListProductByIdsArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ListProductByIdsArgs) GetFirstArgument() interface{} {
	return p.Req
}

type ListProductByIdsResult struct {
	Success *product.ListProductByIdsResp
}

var ListProductByIdsResult_Success_DEFAULT *product.ListProductByIdsResp

func (p *ListProductByIdsResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(product.ListProductByIdsResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *ListProductByIdsResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *ListProductByIdsResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *ListProductByIdsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *ListProductByIdsResult) Unmarshal(in []byte) error {
	msg := new(product.ListProductByIdsResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ListProductByIdsResult) GetSuccess() *product.ListProductByIdsResp {
	if !p.IsSetSuccess() {
		return ListProductByIdsResult_Success_DEFAULT
	}
	return p.Success
}

func (p *ListProductByIdsResult) SetSuccess(x interface{}) {
	p.Success = x.(*product.ListProductByIdsResp)
}

func (p *ListProductByIdsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ListProductByIdsResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) ListProductByIds(ctx context.Context, Req *product.ListProductByIdsReq) (r *product.ListProductByIdsResp, err error) {
	var _args ListProductByIdsArgs
	_args.Req = Req
	var _result ListProductByIdsResult
	if err = p.c.Call(ctx, "ListProductByIds", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
