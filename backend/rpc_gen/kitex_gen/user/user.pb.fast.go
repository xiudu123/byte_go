...
func (x *GetUserInfoReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var ov GetUserInfoReq_UserId
	x.Identifier = &ov
	ov.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}
...
func (x *DeleteUserReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Confirmation, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *DeleteUserReq) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 2, x.GetConfirmation())
	return offset
}
...
func (x *DeleteUserReq) sizeField2() (n int) {
	...
	n += fastpb.SizeString(2, x.GetConfirmation())
	return n
}
