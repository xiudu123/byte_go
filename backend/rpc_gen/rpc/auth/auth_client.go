...
type RPCClient interface {
	...
	ClearUserTokensByRPC(ctx context.Context, Req *auth.ClearUserTokensReq, callOptions ...callopt.Option) (r *common.Empty, err error)
}
...
func (c *clientImpl) ClearUserTokensByRPC(ctx context.Context, Req *auth.ClearUserTokensReq, callOptions ...callopt.Option) (r *common.Empty, err error) {
	return c.kitexClient.ClearUserTokensByRPC(ctx, Req, callOptions...)
}
