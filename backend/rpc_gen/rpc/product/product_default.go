...
func ListProductByIds(ctx context.Context, req *product.ListProductByIdsReq, callOptions ...callopt.Option) (resp *product.ListProductByIdsResp, err error) {
	resp, err = defaultClient.ListProductByIds(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "ListProductByIds call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}
